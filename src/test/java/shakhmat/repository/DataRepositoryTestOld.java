...
public class DataRepositoryTestOld {
  ...
  /** Logger de la classe */
  private static final Logger LOGGER = LoggerFactory.getLogger(DataRepositoryTestOld.class);
  ...
  public void testLectureRepertoireData() {
    ...
    //    assertEquals(listeOuverture.get(0).getCoups().get(0), testOkRuyLopezList.get(0).getCoups().get(0));
    //    assertEquals(listeOuverture.get(0).getCoups().get(1), testOkRuyLopezList.get(0).getCoups().get(1));
    //    assertEquals(listeOuverture.get(0).getCoups().get(2), testOkRuyLopezList.get(0).getCoups().get(2));
  }
